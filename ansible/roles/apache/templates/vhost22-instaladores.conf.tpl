...
<VirtualHost *:80>
   ...
   Alias /{{apache.aliasinstaladores}} {{ apache.pathinstaladores }}
    <Directory "{{ apache.pathinstaladores }}">
	...
	Alias /{{apache.apptoba}}_toba_editor "{{apache.pathtoba}}/toba/proyectos/toba_editor/www"
	<Directory "{{apache.pathtoba}}/toba/proyectos/toba_editor/www/">
		DirectoryIndex aplicacion.php
		Options MultiViews
		AllowOverride None
		Order allow,deny
